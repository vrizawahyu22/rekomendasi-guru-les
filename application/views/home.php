    ...
    <div class="headder-top">
      ...
      <nav>
        ...
        <ul class="menu mt-2">
          ...
          <li><form action="<?php echo base_url(); ?>index.php/brainy_les/viewlogin"><button type="submit" class="btn login" style="padding: 5px 12px 5px 12px; font-size: 14px">Login</button></form></li>
          <li class="dropdown">
            <button class="btn dropdown-toggle button-user" type="button" data-toggle="dropdown" style="background-color: #ff9800">Daftar
            <span class="caret"></span></button>
            <ul class="dropdown-menu dropdown-profile" style="">
              <li><a href="<?php echo base_url(); ?>index.php/brainy_les/viewregistermurid"><i aria-hidden="true"></i>Sebagai Murid</a></li>
              <div class="dropdown-divider"></div>
              <li><a href="<?php echo base_url(); ?>index.php/brainy_les/viewregisterguru"><i aria-hidden="true"></i>Sebagai Guru</a></li>
            </ul>
          </li>
        </ul>
      </nav>
      ...
      <div class="row gallery-info">
        <div class="col-lg-4 col-md-6 col-sm-6 gallery-img-grid my-3">
          <div class="gallery-grids">
            <a href="#gal1">
              <img src="<?php echo base_url(); ?>assets/img/galery1.jpg" alt="news image" class="img-fluid" style="height: 250px">
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 gallery-img-grid my-3">
          <div class="gallery-grids">
            <a href="#gal2">
              <img src="<?php echo base_url(); ?>assets/img/galery2.jpg" alt="news image" class="img-fluid" style="height: 250px">
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 gallery-img-grid my-3">
          <div class="gallery-grids">
            <a href="#gal3">
              <img src="<?php echo base_url(); ?>assets/img/galery3.jpg" alt="news image" class="img-fluid" style="height: 250px">
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 gallery-img-grid my-3">
          <div class="gallery-grids">
            <a href="#gal4">
              <img src="<?php echo base_url(); ?>assets/img/galery4.jpg" alt="news image" class="img-fluid" style="height: 250px">
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 gallery-img-grid my-3">
          <div class="gallery-grids">
            <a href="#gal5">
              <img src="<?php echo base_url(); ?>assets/img/galery5.jpg" alt="news image" class="img-fluid" style="height: 250px">
            </a>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 gallery-img-grid my-3">
          <div class="gallery-grids">
            <a href="#gal6">
              <img src="<?php echo base_url(); ?>assets/img/galery6.jpg" alt="news image" class="img-fluid" style="height: 250px">
            </a>
          </div>
        </div>
      </div>
