    ...
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
      <div class="row">
        <div class="col-lg-7 store-details">
          ...
          <h5> 1. Bagaimana Cara Mencari Guru Les Privat ? </h5>
          <p> Pilih menu Cari Guru, namun anda harus melakukan login terlebih dahulu. Lalu isi form yang tersedia dan lakukan pencarian. Pilih Guru Les Privat yang ada atau jika lebih dari satu pilih sesuai keinginan anda. Selanjutnya ikuti alurnya.</p><br>
          <h5> 2. Bagaimana Cara Mendaftar Sebagai Murid ? </h5>
          <p> Pilih menu "Daftar" dan pilih sebagai murid.</p><br>
        </div>
