    ...
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
      <div class="row">
        <div class="col-lg-7 store-details">
          ...
          <h6 class="mb-2">--------------------------</h6>
          <p>BRAINY merupakan sistem untuk melakukan pencarian dan pemesanan Guru Les Privat. BRAINY akan membantu anda dalam menemukan Guru Les Privat yang sesuai dengan pilihan anda. BRAINY dapat digunakan oleh pelajar mulai dari SD, SMP dan SMA. Tim Kami membuat website ini dilatar belakangi oleh siswa di kota malang yang banyak serta hasil survei yang telah diteliti sebelumnya yaitu kesulitan dalam mencari atau mendapatkan Guru Les Privat yang dapat membantu belajar di luar sekolah. Di BRAINY ini terdapat banyak sekali guru yang akan membantu anda dalam menyelesaikan tugas sekolah anda.</p>
        </div>
